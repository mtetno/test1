...
toggleSymptomQuestions,
  ...
  return (    
    <Row className="clearfix symtonques">
        ...
        <Col sm={12} className="container">
            <div className='middle-content'>
                <ol>
                    {selectedDiease.intensityMin != '0' || selectedDiease.intensityMax != '0' ? <li style={{listStyle: 'none'}}>
            ...
            {/* <div className='next-block pull-right'><Button type="submit" className='next green'>Save</Button></div> */}
        </Col>
    </Row>
  );
};
